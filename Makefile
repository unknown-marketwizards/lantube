...
frontend=$(BINDIR)/frontend/

$(frontend):
	mkdir -p $(BINDIR)/frontend
	cp -rv frontend/dist $(BINDIR)/frontend

zip_releases=$(addsuffix .zip, $(PLATFORM_LIST))

$(zip_releases): %.zip : %
	chmod +x $(BINDIR)/$(NAME)-$(basename $@)
	zip -r $(BINDIR)/$(NAME)-$(basename $@)-$(VERSION).zip $(BINDIR)/$(NAME)-$(basename $@) $(BINDIR)/frontend/dist
	rm $(BINDIR)/$(NAME)-$(basename $@)

all-arch: $(PLATFORM_LIST)

releases: $(frontend) $(zip_releases)
	rm -rf $(frontend)
